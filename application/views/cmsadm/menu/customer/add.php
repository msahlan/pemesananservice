        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('customer/actionadd/');?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtNamaCustomer">Nama Konsumen</label>
		                <div class="col-sm-9">
        							<div class="clearfix">
        								<input class="col-xs-10 col-sm-5" type="text" id="txtNamaCustomer" placeholder="Nama Konsumen" name="txtNamaCustomer" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chCustomerName; ?>" />
        							</div>
        						</div>
        					</div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-10 col-sm-10" type="text" id="txtAddress" placeholder="Alamat" name="txtAddress" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chAddress; ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-10 col-sm-3" type="text" id="txtPhone" placeholder="Telephone" name="txtPhone" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chPhone; ?>" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-10 col-sm-5" type="text" id="txtEmail" placeholder="Email" name="txtEmail" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chEmail; ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <label>
                        <input name="ckbJenisKelamin" class="ace ace-switch ace-switch-4" type="checkbox" <?php echo ($reset) ? 'checked' : ($loJenisKelamin == 'on') ? 'checked':''; ?> />
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        ...
                        <label class="col-sm-3 control-label no-padding-left" for="txtUsername" style="color: red"><?php echo  form_error('chUsername'); ?>
                        </label>
                      </div>
                    </div>
                  </div>
