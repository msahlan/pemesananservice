        ...
        <div class="main-content-inner">
          <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active">Add Data Service</li>
            </ul><!-- /.breadcrumb -->
          </div>
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('service/actionadd/');?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtNamaCustomer">Nama Customer</label>
		                <div class="col-sm-4">
                      <div class="clearfix">
                        <?php echo form_dropdown('cmbCustomer', $customer, "", 'required="required" class="form-control" id="cmbCustomer" onchange="ajaxmotor(this.value)"'); ?>
                      </div>
                    </div>
        					</div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <div class="clearfix">
                        <?php echo form_dropdown('cmbPlatNomor', $platno, "", 'required="required" class="form-control" id="cmbPlatNomor"'); ?>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <div class="clearfix">
                        <?php echo form_dropdown('cmbJenisService', $jenisservice, "", 'required="required" class="form-control" id="cmbJenisService"'); ?>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <div class="clearfix">
                        <input class="form-control date-picker" id="txtTglService" name="txtTglService" type="text" data-date-format="yyyy-mm-dd" readonly="yes" required="yes"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtHarga" placeholder="Ex : 12345" readonly="yes" name="txtHarga" autocomplete="off" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <textarea id="txtKeluhan" name="txtKeluhan" placeholder="Keluhan" class="autosize-transition form-control"></textarea>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $('#cmbJenisService').on('change', function () {
    ...
    if (textBoxVal != "")
    {
      $.ajax({ 
          method: 'GET',
          url: '<?php echo base_url();?>jenisservice/getHargaOffline/'+textBoxVal, // link to CI function
          data: {
              id: textBoxVal
          },
