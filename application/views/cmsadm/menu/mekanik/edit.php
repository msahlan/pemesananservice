        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('mekanik/actionedit/');?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtNamaMekanik">Nama Mekanik</label>
		                <div class="col-sm-9">
        							<div class="clearfix">
        								<input class="col-xs-10 col-sm-5" type="text" id="txtNamaMekanik" placeholder="Nama Mekanik" name="txtNamaMekanik" required="yes" autocomplete="off" value="<?php echo $data['chNamaMekanik'];?>"/>
                        <input class="col-xs-10 col-sm-5" type="hidden"  value="<?php echo $data['inIDMekanik'];?>" 
                        placeholder="Nama" name="inIDMekanik" id="inIDMekanik" required="yes" autocomplete="off" readonly="yes" />
        							</div>
        						</div>
        					</div>
                  <div class="form-group">
