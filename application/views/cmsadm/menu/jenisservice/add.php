        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('jenisservice/actionadd/');?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtJenisService">Jenis Service</label>
		                <div class="col-sm-9">
        							<div class="clearfix">
        								<input class="col-xs-10 col-sm-5" type="text" id="txtJenisService" placeholder="Jenis Service" name="txtJenisService" required="yes" autocomplete="off" />
        							</div>
        						</div>
        					</div>
                  <!-- <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtHargaBooking" placeholder="Ex : 12345" name="txtHargaBooking" required="yes" autocomplete="off" />
                      </div>
                    </div>
                  </div> -->
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtHarga" placeholder="Ex : 12345" name="txtHarga" required="yes" autocomplete="off" />
                      </div>
                    </div>
                  </div>
