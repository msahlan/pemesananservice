                           ...
                           <div class="col-xs-12 col-sm-6">
                              ...
                              <td> 
                                <div class="hidden-sm hidden-xs action-buttons">
                                  ...
                                  <a class="green" href="#" data-href="<?php echo base_url('confirm/detail/'.$confirm['chNoService'].'/'.$confirm['loStatus']);?>">
                                    <i class="ace-icon fa fa-close bigger-130" data-toggle="modal" data-target="#confirm-cancel<?php echo $i;?>" ></i>
                                  </a>
                                </div>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>
                                               <input class="form-control date-picker" id="txtTglService" name="txtTglService" type="text" data-date-format="yyyy-mm-dd" readonly="yes" placeholder="Tanggal Service" value="<?php echo $confirm['daServiceDate'];?>" />
                                            </p>
                                            <p>
                                              <div id="datetimepicker3" class="input-append">
                                                &nbsp; <input type="text" id="dpTime" name="dpTime" class="col-xs-3" placeholder="00:00" readonly="yes" value="<?php echo $confirm['chTime'];?>" />
                                              </div>
                                            </p>
                                            <p class="debug-url"></p>
                                        </div>
                                ...
                                <form class="form-horizontal" role="form" action="<?php echo base_url('confirm/actioncancel/'.$confirm['chNoService'].'/'.$confirm['inIDCustomer']);?>" enctype="multipart/form-data" method="POST">
                                  <div class="modal fade" id="confirm-cancel<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Cancel Booking Service</h4>
                                        </div>
                                    
                                        <div class="modal-body">
                                            <p>You are about to cancel this booking service.</p>
                                            <p>Do you want to proceed?</p>
                                            <p class="debug-url"></p>
                                        </div>
                                        <div class="modal-footer">
