        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('customer/actionaddmotor/'.$inIDCustomer);?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtNamaCustomer">Nama Customer</label>
		                <div class="col-sm-9">
        							<div class="clearfix">
        								<input class="col-xs-10 col-sm-5" type="text" id="txtNamaCustomer" placeholder="Nama Customer" name="txtNamaCustomer" required="yes" readonly="true" autocomplete="off" value="<?php echo ($reset) ? $data['chCustomerName'] : $chCustomerName; ?>"/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-2" type="text" id="txtPlatNomor" placeholder="Plat Nomor" name="txtPlatNomor" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chNoMotor; ?>" />
                ...
                <!--   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-8 col-sm-5" type="text" id="txtJenisMotor" placeholder="Jenis Motor" name="txtJenisMotor" required="yes" autocomplete="off" value="<?php echo ($reset) ? "" : $chJenisMotor; ?>"/>
                      </div>
                    </div>
                  </div> -->
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <div class="clearfix">
                        <select class="form-control" id="txtJenisMotor" name="txtJenisMotor" required="required">
                          <option value=""></option>
                          <option value="Matic" <?php echo ($reset) ? '' : ($chJenisMotor == 'Matic')?'selected':'';?> >Matic</option>
                          <option value="Bebek" <?php echo ($reset) ? '' : ($chJenisMotor == 'Bebek')?'selected':'';?>>Bebek</option>
                          <option value="Sport" <?php echo ($reset) ? '' : ($chJenisMotor == 'Sport')?'selected':'';?>>Sport</option>
                        </select>
                      </div>
                    </div>
                  </div>
