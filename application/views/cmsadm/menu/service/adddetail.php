        ...
        <div class="main-content-inner">
          <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active">Add Detail Sparepart</li>
            </ul><!-- /.breadcrumb -->
          </div>
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('service/actionadddetail/'.$noservice.'/'.$status);?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="cmbSparepart">Sparepart</label>
		                <div class="col-sm-4">
                      <div class="clearfix">
                        <?php echo form_dropdown('cmbSparepart', $sparepart, ($reset) ? '' : $inIDSparepart, 'required="required" class="form-control" id="cmbSparepart" '); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtHarga" placeholder="Ex : 12345" readonly="yes" name="txtHarga" autocomplete="off" value="<?php echo ($reset) ? '' : $inHarga; ?>"/>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtOngkosPasang" placeholder="Ex : 12345" readonly="yes" name="txtOngkosPasang" autocomplete="off" value="<?php echo ($reset) ? '' : $inOngkosPasang; ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtStock" placeholder="Ex : 12345" name="txtStock" autocomplete="off" readonly="yes" value="<?php echo ($reset) ? '' : $inStock; ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-1" type="text" id="txtQty" placeholder="Ex : 12345" name="txtQty" required="yes" autocomplete="off" value="<?php echo ($reset) ? '' : $inQty; ?>" />
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $('#cmbSparepart').on('change', function () {
    ...
    if (textBoxVal != "")
    {
      ...
      $.ajax({ 
          method: 'GET',
          url: '<?php echo base_url();?>sparepart/getHarga/'+textBoxVal+'/'+textNoService, // link to CI function
          data: {
              id: textBoxVal
          },
          success: function (result) {
