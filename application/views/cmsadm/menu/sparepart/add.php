        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
           			<form class="form-horizontal" role="form" action="<?php echo base_url('sparepart/actionadd/');?>" enctype="multipart/form-data" method="POST">
        					<div class="form-group">
        						<label class="col-sm-3 control-label no-padding-right" for="txtNamaSparepart">Nama Sparepart</label>
		                <div class="col-sm-9">
        							<div class="clearfix">
        								<input class="col-xs-10 col-sm-5" type="text" id="txtNamaSparepart" placeholder="Nama Sparepart" name="txtNamaSparepart" required="yes" autocomplete="off" />
        							</div>
        						</div>
        					</div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-6 col-sm-3" type="text" id="txtKdSparepart" placeholder="Kode Sparepart" name="txtKdSparepart" required="yes" autocomplete="off" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <textarea id="txtDescription" name="txtDescription" placeholder="Description" class="col-xs-6 col-sm-10" ></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-3" type="text" id="txtHarga" placeholder="Ex : 12345" name="txtHarga" required="yes" autocomplete="off" />
                      </div>
                    </div>
                  </div>
				          <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-3" type="text" id="txtStock" placeholder="Ex : 12345" name="txtStock" required="yes" autocomplete="off" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="clearfix">
                        <input class="col-xs-3" type="text" id="txtOngkosPasang" placeholder="Ex : 12345" name="txtOngkosPasang" autocomplete="off" />
                      </div>
                    </div>
                  </div>
